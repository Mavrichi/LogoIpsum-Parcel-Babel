...
document.addEventListener("DOMContentLoaded", () => {
   ...
   const templateHandlebars =
      '{{#each product}} <div class="product-card"> <img class="product-image img-fluid" src="{{img}}" alt="product-image"> <div class="product-imfo"><h1>{{title}}</h1> <p>{{price}}EUR</p> <button class="button2">Buy now</button> </div></div> {{/each}}';
   ...
   var featuredEl = document.querySelector(
